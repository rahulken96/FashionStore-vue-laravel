            ...
            <div class="card-block">
                <form action="{{ route('produk.update', $produk->produk_id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tipe_produk" id="tipe_produk" value="{{ old('tipe_produk', $produk->tipe_produk) }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi_produk" id="deskripsi_produk" class="form-control @error('deskripsi_produk') is-invalid @enderror" rows="30">{{ old('deskripsi_produk', $produk->deskripsi_produk) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="harga_produk" id="harga_produk" value="{{ old('harga_produk', $produk->harga_produk) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="produk_qty" id="produk_qty" value="{{ old('produk_qty', $produk->produk_qty) }}"
